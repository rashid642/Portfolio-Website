...
export const Cards1 = () => {
    return (
        <div className="flex items-center justify-center">
            <div className={`w-3/4 border-r-4 border-b-4 p-4 shadow-lg shadow-cyan-500/50 border-solid border-white bg-black bg-opacity-30 rounded-xl overflow-hidden shadow-lg flex max-md:flex-col max-md:w-11/12 max-md:p-0 max-md:m-2 `}>
